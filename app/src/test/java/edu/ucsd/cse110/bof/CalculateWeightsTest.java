...
public class CalculateWeightsTest {
    ...
    public void sampleClassSizeTest() {
        ...
        float weight = BoFsTracker.calcClassSizeWeight(commonCourses);
    ...
    public void sampleRecencyTest() {
        ...
        int weight = BoFsTracker.calcRecencyWeight(commonCourses);
    ...
    public void summerRecencyTest() {
        ...
        weight = BoFsTracker.calcRecencyWeight(commonCourses);
